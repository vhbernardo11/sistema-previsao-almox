...
(function(){
  ...
  function loadAdminEnhanced(){if(document.querySelector('script[data-integratrampo-admin-enhanced]'))return;const s=document.createElement('script');s.src='./admin-enhanced.js?v=1';s.defer=true;s.dataset.integratrampoAdminEnhanced='1';document.body.appendChild(s)}
  ...
  function loadAutoApproveLayer(){if(document.querySelector('script[data-integratrampo-auto-approve]')){loadSeoLayer();return}const s=document.createElement('script');s.src='./auto-approve.js?v=2';s.defer=true;s.dataset.integratrampoAutoApprove='1';s.onload=loadSeoLayer;s.onerror=loadSeoLayer;document.body.appendChild(s)}
  function loadPremiumLayer(){if(document.querySelector('script[data-integratrampo-premium]')){loadAutoApproveLayer();return}const s=document.createElement('script');s.src='./premium.js?v=1';s.defer=true;s.dataset.integratrampoPremium='1';s.onload=loadAutoApproveLayer;s.onerror=loadAutoApproveLayer;document.body.appendChild(s)}
  function loadUserPlusLayer(){if(document.querySelector('script[data-integratrampo-user-plus]')){loadPremiumLayer();return}const s=document.createElement('script');s.src='./user-plus.js?v=1';s.defer=true;s.dataset.integratrampoUserPlus='1';s.onload=loadPremiumLayer;s.onerror=loadPremiumLayer;document.body.appendChild(s)}
  function loadUserLayer(){if(document.querySelector('script[data-integratrampo-user]')){loadUserPlusLayer();return}const s=document.createElement('script');s.src='./user.js?v=2';s.defer=true;s.dataset.integratrampoUser='1';s.onload=loadUserPlusLayer;s.onerror=loadUserPlusLayer;document.body.appendChild(s)}
  window.addEventListener('load',()=>{if(document.querySelector('script[data-integratrampo-auth]')){loadUserLayer();return}const s=document.createElement('script');s.src='./auth.js?v=1';s.defer=true;s.dataset.integratrampoAuth='1';s.onload=loadUserLayer;s.onerror=loadUserLayer;document.body.appendChild(s)}, {once:true});
})();