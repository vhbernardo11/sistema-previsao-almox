...
(function(){
  ...
  function loadProfileControlsLayer(){if(document.querySelector('script[data-integratrampo-profile-controls]')){loadPremiumLayer();return}const s=document.createElement('script');s.src='./profile-controls-v3.js?v=1';s.defer=true;s.dataset.integratrampoProfileControls='1';s.onload=loadPremiumLayer;s.onerror=loadPremiumLayer;document.body.appendChild(s)}
  ...
  window.addEventListener('load',()=>{if(document.querySelector('script[data-integratrampo-auth]')){loadUserLayer();return}const s=document.createElement('script');s.src='./auth.js?v=2';s.defer=true;s.dataset.integratrampoAuth='1';s.onload=loadUserLayer;s.onerror=loadUserLayer;document.body.appendChild(s)}, {once:true});
})();