...
(function(){
  ...
  function loadAuthV4(){if(document.querySelector('script[data-integratrampo-auth-v4]')){loadUserLayer();return}const s=document.createElement('script');s.src='./auth-v4.js?v=1';s.defer=true;s.dataset.integratrampoAuthV4='1';s.onload=loadUserLayer;s.onerror=loadUserLayer;document.body.appendChild(s)}
